...
urlpatterns = [
    ...
    path('post/<int:post_id>/share/followers/', views.share_post_followers, name='share_post_followers'),
    ...
    path('notifications/<str:notification_id>/mark-read/', views.mark_notification_read, name='mark_notification_read'),
